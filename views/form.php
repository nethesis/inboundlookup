...
$thisItem = inboundlookup_get();

?>

<form autocomplete="off" class="fpbx-submit" name="edit" id="edit" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="return edit_onsubmit();" data-fpbx-delete="config.php?display=inboundlookup&view=form&amp;itemid=<?php echo $itemid?>&amp;action=delete">
<input type="hidden" name="display" value="inboundlookup">
